...
const releases = [
  {
    title: "Perfect Dark Originals", // Replace with your actual playlist title
    src: "https://open.spotify.com/embed/playlist/4qiTCCPzzGZfU2r4CvqHDi?utm_source=generator&theme=0",
    link: "https://open.spotify.com/playlist/4qiTCCPzzGZfU2r4CvqHDi",
  },
  // ,
  // {
  ...
  //   src: "https://bandcamp.com/EmbeddedPlayer/album=2291690602/size=large/bgcol=333333/linkcol=0687f5/tracklist=false/transparent=true/",
...
const Discography = () => {
  return (
    <div className="flex flex-row items-center justify-center p-20 mx-auto max-w-6xl">
      {/* {releases.map((release) => {
        return <MusicElement release={release} />;
      })} */}
      <iframe
        style={{ borderRadius: "12px" }} // Change this line
        src="https://open.spotify.com/embed/playlist/4qiTCCPzzGZfU2r4CvqHDi?utm_source=generator&theme=0"
        width="100%"
        height="352"
        frameBorder="0"
